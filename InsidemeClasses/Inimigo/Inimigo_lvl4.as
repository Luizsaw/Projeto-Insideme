package InsidemeClasses.Inimigo
{
	 ...
	 */
	public class Inimigo_lvl4 extends MovieClip
	{
		public var dano:Number = 10;
		public var danoMax:Number = 85;
		...
		private var atkInimigo:AtkInimigo_lvl4 = new AtkInimigo_lvl4();
		...
		public function checarObj(obj:MovieClip, obj2:MovieClip, place, padraoChao:int, danoOn:Boolean, ataqueLaura:Boolean, danoMaxOn):void
		{
			...
			if (cont3 == 0)
			{
				...
				if (Math.abs(obj.x - x) < larguraPersonagem / 2 + 1000 / 2 && Math.abs(obj.y - y) < larguraPersonagem / 2 + 1000 / 2)
				{
					atk = true;
				}
				else
