package InsidemeClasses.Inimigo
{
	 ...
	 */
	public class Inimigo_lvl2 extends MovieClip
	{
		public var dano:Number = 3;
		public var danoMax:Number = 50;
		...
		private var atkInimigo:AtkInimigo_lvl2 = new AtkInimigo_lvl2();
		...
		public function checarObj(obj:MovieClip, obj2:MovieClip, place, padraoChao:int, danoOn:Boolean, ataqueLaura:Boolean, danoMaxOn):void
		{
			...
			if (cont3 == 0)
			{
				...
				if (Math.abs(obj.x - x) < larguraPersonagem / 2 + 600 / 2 && Math.abs(obj.y - y) < larguraPersonagem / 2 + 600 / 2)
				{
					atk = true;
				}
				else
