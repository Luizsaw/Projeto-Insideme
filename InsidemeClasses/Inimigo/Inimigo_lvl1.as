package InsidemeClasses.Inimigo
{
	 ...
	 */
	public class Inimigo_lvl1 extends MovieClip
	{
		public var dano:Number = 2;
		public var danoMax:Number = 20;
		...
		private var atkInimigo:AtkInimigo_lvl1 = new AtkInimigo_lvl1();
		...
		public function checarObj(obj:MovieClip, obj2:MovieClip, place, padraoChao:int, danoOn:Boolean, ataqueLaura:Boolean, danoMaxOn):void
		{
			...
			if (cont3 == 0)
			{
				...
				if (Math.abs(obj.x - x) < larguraPersonagem / 2 + 400 / 2 && Math.abs(obj.y - y) < larguraPersonagem / 2 + 400 / 2)
				{
					atk = true;
				}
				else
