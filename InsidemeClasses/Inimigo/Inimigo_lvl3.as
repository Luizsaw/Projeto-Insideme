package InsidemeClasses.Inimigo
{
	 ...
	 */
	public class Inimigo_lvl3 extends MovieClip
	{
		public var dano:Number = 7;
		public var danoMax:Number = 70;
		...
		private var atkInimigo:AtkInimigo_lvl3 = new AtkInimigo_lvl3();
		...
		public function checarObj(obj:MovieClip, obj2:MovieClip, place, padraoChao:int, danoOn:Boolean, ataqueLaura:Boolean, danoMaxOn):void
		{
			...
			if (cont3 == 0)
			{
				...
				if (Math.abs(obj.x - x) < larguraPersonagem / 2 + 800 / 2 && Math.abs(obj.y - y) < larguraPersonagem / 2 + 800 / 2)
				{
					atk = true;
				}
				else
